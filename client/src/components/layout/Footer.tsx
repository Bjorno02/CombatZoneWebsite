  ...
  return (
    <footer className="bg-black border-t border-white/10 pt-24 pb-12 text-white">
      <div className="max-w-[1280px] mx-auto px-8 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 border-b border-white/10 pb-12 md:pb-16 mb-12 md:mb-16">
            <div className="max-w-xl">
                <h3 className="text-2xl sm:text-3xl font-bold font-[Chakra_Petch] uppercase italic mb-4">Join the Fight Club</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                    <input type="email" placeholder="Enter your email" className="bg-white/5 border border-white/10 px-4 py-2 w-full sm:max-w-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-primary" />
                    <Button className="bg-primary hover:bg-primary/90 text-white font-bold uppercase w-full sm:w-auto whitespace-nowrap">Subscribe</Button>
                </div>
            </div>
            <div className="flex flex-col items-start md:items-end justify-center">
                 <h3 className="text-xl sm:text-2xl font-bold font-[Chakra_Petch] uppercase italic mb-4">Connect With Us</h3>
                 <div className="flex gap-4">
                    <a 
                        href="https://www.instagram.com/combatzonemma/" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary hover:scale-110 transition-all"
                    >
                        <Instagram size={20} />
                    </a>
                    <a 
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 gap-4">
          <p className="text-center md:text-left">&copy; {new Date().getFullYear()} Combat Zone MMA. All rights reserved.</p>
